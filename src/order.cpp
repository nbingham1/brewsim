...
void order_t::load(grammar_t &grammar)
{
	...
	HAVE = grammar.rules.size();
	grammar.rules.push_back(rule_t(HAVE, "order::have", true, true));
	NEED = grammar.rules.size();
	grammar.rules.push_back(rule_t(NEED, "order::need", true, true));
	...
	n[20] = grammar.insert(new stem(8, true));
	...
	n[47] = grammar.insert(new stem(15, true));
	n[48] = grammar.insert(new stem(14, true));
	...
	n[53] = grammar.insert(new stem(14, true));
	n[54] = grammar.insert(new stem(13, true));
	...
	n[63] = grammar.insert(new stem(13, true));
	n[64] = grammar.insert(new stem(12, true));
	...
	n[69] = grammar.insert(new stem(12, true));
	...
	n[78] = grammar.insert(new stem(9, true));
	...
	n[88] = grammar.insert(new stem(11, true));
	...
	n[97] = grammar.insert(new stem(8, true));
	...
	n[102] = grammar.insert(new stem(8, true));
	n[103] = grammar.insert(new stem(1, true));
	n[104] = grammar.insert(new regular_expression("need", false));
	n[105] = grammar.insert(new regular_expression(";", false));
	n[106] = grammar.insert(new stem(1, true));
	n[107] = grammar.insert(new stem(8, true));
	n[108] = grammar.insert(new stem(1, true));
	n[109] = grammar.insert(new regular_expression("max", true));
	n[110] = grammar.insert(new regular_expression("min", true));
	n[111] = grammar.insert(new regular_expression(";", false));
	n[112] = grammar.insert(new stem(1, true));
	n[113] = grammar.insert(new stem(8, true));
	n[114] = grammar.insert(new stem(1, true));
	n[115] = grammar.insert(new regular_expression("=", false));
	n[116] = grammar.insert(new stem(1, true));
	n[117] = grammar.insert(new stem(9, true));
	n[118] = grammar.insert(new stem(1, true));
	n[119] = grammar.insert(new regular_expression("let", false));
	n[120] = grammar.insert(new regular_expression(";", false));
	n[121] = grammar.insert(new stem(1, true));
	n[122] = grammar.insert(new stem(9, true));
	n[123] = grammar.insert(new stem(1, true));
	n[124] = grammar.insert(new stem(8, true));
	n[125] = grammar.insert(new stem(1, true));
	n[126] = grammar.insert(new regular_expression(",", false));
	n[127] = grammar.insert(new stem(1, true));
	n[128] = grammar.insert(new stem(9, true));
	n[129] = grammar.insert(new stem(1, true));
	n[130] = grammar.insert(new stem(8, true));
	n[131] = grammar.insert(new stem(1, true));
	n[132] = grammar.insert(new regular_expression("have", false));
	n[133] = grammar.insert(new regular_expression("\\0", false));
	n[134] = grammar.insert(new stem(1, true));
	n[135] = grammar.insert(new stem(7, true));
	n[136] = grammar.insert(new stem(6, true));
	n[137] = grammar.insert(new stem(5, true));
	n[138] = grammar.insert(new stem(4, true));
	n[139] = grammar.insert(new stem(3, true));
	n[140] = grammar.insert(new stem(2, true));
	n[141] = grammar.insert(new stem(1, true));
	...
	n[120]->next.push_back(NULL);
	n[121]->next.push_back(n[120]);
	n[122]->next.push_back(n[127]);
	...
	n[135]->next.push_back(n[141]);
	n[135]->next.push_back(n[134]);
	n[136]->next.push_back(n[141]);
	n[136]->next.push_back(n[134]);
	n[137]->next.push_back(n[141]);
	n[137]->next.push_back(n[134]);
	n[138]->next.push_back(n[141]);
	n[138]->next.push_back(n[134]);
	n[139]->next.push_back(n[141]);
	n[139]->next.push_back(n[134]);
	n[140]->next.push_back(n[141]);
	n[140]->next.push_back(n[134]);
	n[141]->next.push_back(n[140]);
	n[141]->next.push_back(n[139]);
	n[141]->next.push_back(n[138]);
	n[141]->next.push_back(n[137]);
	n[141]->next.push_back(n[136]);
	n[141]->next.push_back(n[135]);

	grammar.rules[0].start.push_back(n[141]);
	grammar.rules[1].start.push_back(n[0]);
	grammar.rules[2].start.push_back(n[132]);
	grammar.rules[3].start.push_back(n[104]);
	grammar.rules[4].start.push_back(n[119]);
	grammar.rules[5].start.push_back(n[110]);
	grammar.rules[5].start.push_back(n[109]);
	grammar.rules[6].start.push_back(n[99]);
	grammar.rules[7].start.push_back(n[94]);
	grammar.rules[8].start.push_back(n[69]);
	grammar.rules[9].start.push_back(n[1]);
	grammar.rules[10].start.push_back(n[2]);
	grammar.rules[11].start.push_back(n[85]);
	grammar.rules[11].start.push_back(n[84]);
	grammar.rules[11].start.push_back(n[83]);
	grammar.rules[11].start.push_back(n[82]);
	grammar.rules[12].start.push_back(n[63]);
	grammar.rules[13].start.push_back(n[53]);
	grammar.rules[14].start.push_back(n[47]);
	grammar.rules[15].start.push_back(n[40]);
	grammar.rules[15].start.push_back(n[38]);
	grammar.rules[16].start.push_back(n[37]);
	grammar.rules[16].start.push_back(n[35]);
	grammar.rules[17].start.push_back(n[34]);
	grammar.rules[17].start.push_back(n[29]);
	grammar.rules[17].start.push_back(n[28]);
	grammar.rules[17].start.push_back(n[27]);
	grammar.rules[18].start.push_back(n[3]);
	grammar.rules[19].start.push_back(n[26]);
	grammar.rules[19].start.push_back(n[25]);
	grammar.rules[19].start.push_back(n[24]);
	grammar.rules[19].start.push_back(n[17]);
	grammar.rules[19].start.push_back(n[16]);
	grammar.rules[19].start.push_back(n[15]);
	grammar.rules[19].start.push_back(n[14]);
}
