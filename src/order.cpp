...
void order_t::load(grammar_t &grammar)
{
	...
	n[61] = grammar.insert(new stem(7, true));
	n[62] = grammar.insert(new stem(1, true));
	n[63] = grammar.insert(new regular_expression("produces", true));
	n[64] = grammar.insert(new regular_expression("consumes", true));
	n[65] = grammar.insert(new regular_expression("locks", true));
	n[66] = grammar.insert(new regular_expression("uses", true));
	n[67] = grammar.insert(new regular_expression("}", false));
	...
	n[75] = grammar.insert(new regular_expression("task", false));
	...
	n[80] = grammar.insert(new regular_expression("keep", true));
	...
	n[85] = grammar.insert(new regular_expression("max", true));
	n[86] = grammar.insert(new regular_expression("min", true));
	n[87] = grammar.insert(new regular_expression(";", false));
	n[88] = grammar.insert(new stem(1, true));
	n[89] = grammar.insert(new stem(7, true));
	n[90] = grammar.insert(new stem(1, true));
	n[91] = grammar.insert(new regular_expression("=", true));
	n[92] = grammar.insert(new stem(1, true));
	n[93] = grammar.insert(new stem(8, true));
	n[94] = grammar.insert(new stem(1, true));
	n[95] = grammar.insert(new regular_expression("where", true));
	n[96] = grammar.insert(new regular_expression(";", false));
	n[97] = grammar.insert(new stem(1, true));
	n[98] = grammar.insert(new stem(8, true));
	...
	n[106] = grammar.insert(new stem(7, true));
	n[107] = grammar.insert(new stem(1, true));
	n[108] = grammar.insert(new regular_expression("need", true));
	n[109] = grammar.insert(new regular_expression("have", true));
	n[110] = grammar.insert(new regular_expression("\\0", false));
	n[111] = grammar.insert(new stem(1, true));
	n[112] = grammar.insert(new stem(6, true));
	n[113] = grammar.insert(new stem(5, true));
	n[114] = grammar.insert(new stem(4, true));
	n[115] = grammar.insert(new stem(3, true));
	n[116] = grammar.insert(new stem(2, true));
	n[117] = grammar.insert(new stem(1, true));
	...
	n[96]->next.push_back(NULL);
	n[97]->next.push_back(n[96]);
	n[98]->next.push_back(n[103]);
	...
	n[110]->next.push_back(NULL);
	n[111]->next.push_back(n[110]);
	n[112]->next.push_back(n[117]);
	n[112]->next.push_back(n[111]);
	n[113]->next.push_back(n[117]);
	n[113]->next.push_back(n[111]);
	n[114]->next.push_back(n[117]);
	n[114]->next.push_back(n[111]);
	n[115]->next.push_back(n[117]);
	n[115]->next.push_back(n[111]);
	n[116]->next.push_back(n[117]);
	n[116]->next.push_back(n[111]);
	...
	grammar.rules[0].start.push_back(n[117]);
	grammar.rules[1].start.push_back(n[0]);
	grammar.rules[2].start.push_back(n[109]);
	grammar.rules[2].start.push_back(n[108]);
	grammar.rules[3].start.push_back(n[95]);
	grammar.rules[4].start.push_back(n[86]);
	grammar.rules[4].start.push_back(n[85]);
	grammar.rules[5].start.push_back(n[80]);
	grammar.rules[6].start.push_back(n[75]);
	...
	grammar.rules[11].start.push_back(n[66]);
	grammar.rules[11].start.push_back(n[65]);
	grammar.rules[11].start.push_back(n[64]);
