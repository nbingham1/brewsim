...
void order_t::load(grammar_t &grammar)
{
	...
	BOOLEAN = grammar.rules.size();
	grammar.rules.push_back(rule_t(BOOLEAN, "order::boolean", true, true));
	...
	BOOLEAN0 = grammar.rules.size();
	grammar.rules.push_back(rule_t(BOOLEAN0, "order::boolean0", true, true));
	BOOLEAN1 = grammar.rules.size();
	grammar.rules.push_back(rule_t(BOOLEAN1, "order::boolean1", true, true));
	...
	FLOAT = grammar.rules.size();
	grammar.rules.push_back(rule_t(FLOAT, "order::float", true, true));
	...
	n[13] = grammar.insert(new stem(15, true));
	...
	n[40] = grammar.insert(new stem(8, true));
	n[41] = grammar.insert(new stem(13, true));
	n[42] = grammar.insert(new stem(1, true));
	n[43] = grammar.insert(new regular_expression("not", true));
	n[44] = grammar.insert(new stem(12, true));
	n[45] = grammar.insert(new stem(1, true));
	n[46] = grammar.insert(new regular_expression("xor", true));
	n[47] = grammar.insert(new regular_expression("or", true));
	n[48] = grammar.insert(new regular_expression("and", true));
	n[49] = grammar.insert(new stem(1, true));
	n[50] = grammar.insert(new stem(12, true));
	n[51] = grammar.insert(new regular_expression(";", false));
	n[52] = grammar.insert(new stem(1, true));
	n[53] = grammar.insert(new stem(7, true));
	n[54] = grammar.insert(new stem(1, true));
	n[55] = grammar.insert(new stem(8, true));
	n[56] = grammar.insert(new stem(1, true));
	n[57] = grammar.insert(new regular_expression("produces", true));
	n[58] = grammar.insert(new regular_expression("consumes", true));
	n[59] = grammar.insert(new regular_expression("locks", true));
	n[60] = grammar.insert(new regular_expression("uses", true));
	n[61] = grammar.insert(new regular_expression("}", false));
	n[62] = grammar.insert(new stem(1, true));
	n[63] = grammar.insert(new stem(11, true));
	n[64] = grammar.insert(new stem(1, true));
	n[65] = grammar.insert(new regular_expression("{", false));
	n[66] = grammar.insert(new stem(1, true));
	n[67] = grammar.insert(new stem(10, true));
	n[68] = grammar.insert(new stem(1, true));
	n[69] = grammar.insert(new regular_expression("task", false));
	...
	n[74] = grammar.insert(new regular_expression("keep", true));
	n[75] = grammar.insert(new regular_expression(";", false));
	n[76] = grammar.insert(new stem(1, true));
	n[77] = grammar.insert(new stem(8, true));
	n[78] = grammar.insert(new stem(1, true));
	n[79] = grammar.insert(new regular_expression("max", true));
	n[80] = grammar.insert(new regular_expression("min", true));
	n[81] = grammar.insert(new regular_expression(";", false));
	n[82] = grammar.insert(new stem(1, true));
	n[83] = grammar.insert(new stem(8, true));
	n[84] = grammar.insert(new stem(1, true));
	n[85] = grammar.insert(new regular_expression("=", true));
	n[86] = grammar.insert(new stem(1, true));
	n[87] = grammar.insert(new stem(7, true));
	n[88] = grammar.insert(new stem(1, true));
	n[89] = grammar.insert(new regular_expression("where", true));
	n[90] = grammar.insert(new regular_expression(";", false));
	n[91] = grammar.insert(new stem(1, true));
	n[92] = grammar.insert(new stem(8, true));
	n[93] = grammar.insert(new stem(1, true));
	n[94] = grammar.insert(new regular_expression("=", true));
	n[95] = grammar.insert(new stem(1, true));
	n[96] = grammar.insert(new stem(7, true));
	n[97] = grammar.insert(new stem(1, true));
	n[98] = grammar.insert(new regular_expression("need", true));
	n[99] = grammar.insert(new regular_expression("have", true));
	n[100] = grammar.insert(new regular_expression("\\0", false));
	n[101] = grammar.insert(new stem(1, true));
	n[102] = grammar.insert(new stem(6, true));
	n[103] = grammar.insert(new stem(5, true));
	n[104] = grammar.insert(new stem(4, true));
	n[105] = grammar.insert(new stem(3, true));
	n[106] = grammar.insert(new stem(2, true));
	...
	n[58]->next.push_back(n[56]);
	n[59]->next.push_back(n[56]);
	n[60]->next.push_back(n[56]);
	n[61]->next.push_back(NULL);
	n[62]->next.push_back(n[61]);
	n[63]->next.push_back(n[64]);
	...
	n[99]->next.push_back(n[97]);
	n[100]->next.push_back(NULL);
	n[101]->next.push_back(n[100]);
	n[102]->next.push_back(n[107]);
	n[102]->next.push_back(n[101]);
	n[103]->next.push_back(n[107]);
	n[103]->next.push_back(n[101]);
	n[104]->next.push_back(n[107]);
	n[104]->next.push_back(n[101]);
	n[105]->next.push_back(n[107]);
	n[105]->next.push_back(n[101]);
	n[106]->next.push_back(n[107]);
	n[106]->next.push_back(n[101]);
	n[107]->next.push_back(n[106]);
	n[107]->next.push_back(n[105]);
	n[107]->next.push_back(n[104]);
	n[107]->next.push_back(n[103]);
	n[107]->next.push_back(n[102]);

	grammar.rules[0].start.push_back(n[107]);
	grammar.rules[1].start.push_back(n[0]);
	grammar.rules[2].start.push_back(n[99]);
	grammar.rules[2].start.push_back(n[98]);
	grammar.rules[3].start.push_back(n[89]);
	grammar.rules[4].start.push_back(n[80]);
	grammar.rules[4].start.push_back(n[79]);
	grammar.rules[5].start.push_back(n[74]);
	grammar.rules[6].start.push_back(n[69]);
	grammar.rules[7].start.push_back(n[1]);
	grammar.rules[8].start.push_back(n[25]);
	grammar.rules[9].start.push_back(n[50]);
	grammar.rules[10].start.push_back(n[2]);
	grammar.rules[11].start.push_back(n[60]);
	grammar.rules[11].start.push_back(n[59]);
	grammar.rules[11].start.push_back(n[58]);
	grammar.rules[11].start.push_back(n[57]);
	grammar.rules[12].start.push_back(n[43]);
	grammar.rules[12].start.push_back(n[41]);
	grammar.rules[13].start.push_back(n[40]);
	grammar.rules[13].start.push_back(n[30]);
	grammar.rules[14].start.push_back(n[19]);
	grammar.rules[15].start.push_back(n[12]);
	grammar.rules[15].start.push_back(n[10]);
	grammar.rules[15].start.push_back(n[9]);
	grammar.rules[15].start.push_back(n[8]);
	grammar.rules[16].start.push_back(n[3]);
}
