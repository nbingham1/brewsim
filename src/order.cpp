...
void order_t::load(grammar_t &grammar)
{
	...
	RULE = grammar.rules.size();
	grammar.rules.push_back(rule_t(RULE, "order::rule", true, true));
	...
	ASSIGNS = grammar.rules.size();
	grammar.rules.push_back(rule_t(ASSIGNS, "order::assigns", true, true));
	TEXT = grammar.rules.size();
	grammar.rules.push_back(rule_t(TEXT, "order::text", true, true));
	ASSIGN = grammar.rules.size();
	grammar.rules.push_back(rule_t(ASSIGN, "order::assign", true, true));
	...
	n[14] = grammar.insert(new regular_expression("[a-zA-Z_][a-zA-Z0-9_]*", true));
	n[15] = grammar.insert(new stem(9, true));
	n[16] = grammar.insert(new stem(20, true));
	n[17] = grammar.insert(new stem(19, true));
	...
	n[48] = grammar.insert(new regular_expression(">", true));
	n[49] = grammar.insert(new regular_expression("<", true));
	n[50] = grammar.insert(new stem(1, true));
	n[51] = grammar.insert(new stem(14, true));
	n[52] = grammar.insert(new stem(13, true));
	n[53] = grammar.insert(new stem(1, true));
	n[54] = grammar.insert(new regular_expression("or", true));
	n[55] = grammar.insert(new regular_expression("and", true));
	n[56] = grammar.insert(new stem(1, true));
	n[57] = grammar.insert(new stem(13, true));
	n[58] = grammar.insert(new stem(8, true));
	n[59] = grammar.insert(new stem(1, true));
	...
	n[64] = grammar.insert(new stem(9, true));
	n[65] = grammar.insert(new stem(1, true));
	n[66] = grammar.insert(new stem(12, true));
	n[67] = grammar.insert(new stem(1, true));
	n[68] = grammar.insert(new regular_expression(",", false));
	n[69] = grammar.insert(new stem(1, true));
	n[70] = grammar.insert(new stem(12, true));
	n[71] = grammar.insert(new stem(11, true));
	n[72] = grammar.insert(new stem(1, true));
	n[73] = grammar.insert(new regular_expression(":", false));
	n[74] = grammar.insert(new stem(1, true));
	n[75] = grammar.insert(new stem(10, true));
	n[76] = grammar.insert(new stem(1, true));
	n[77] = grammar.insert(new regular_expression(";", false));
	n[78] = grammar.insert(new stem(1, true));
	n[79] = grammar.insert(new stem(10, true));
	n[80] = grammar.insert(new stem(1, true));
	n[81] = grammar.insert(new regular_expression("->", false));
	n[82] = grammar.insert(new stem(1, true));
	n[83] = grammar.insert(new stem(8, true));
	n[84] = grammar.insert(new regular_expression(";", false));
	n[85] = grammar.insert(new stem(1, true));
	n[86] = grammar.insert(new stem(8, true));
	n[87] = grammar.insert(new stem(1, true));
	n[88] = grammar.insert(new regular_expression("keep", false));
	n[89] = grammar.insert(new regular_expression(";", false));
	n[90] = grammar.insert(new stem(1, true));
	n[91] = grammar.insert(new stem(8, true));
	n[92] = grammar.insert(new stem(1, true));
	n[93] = grammar.insert(new regular_expression("max", true));
	n[94] = grammar.insert(new regular_expression("min", true));
	...
	n[99] = grammar.insert(new regular_expression("=", false));
	n[100] = grammar.insert(new stem(1, true));
	n[101] = grammar.insert(new stem(9, true));
	n[102] = grammar.insert(new stem(1, true));
	n[103] = grammar.insert(new regular_expression("let", false));
	n[104] = grammar.insert(new regular_expression(";", false));
	n[105] = grammar.insert(new stem(1, true));
	n[106] = grammar.insert(new stem(8, true));
	n[107] = grammar.insert(new stem(1, true));
	n[108] = grammar.insert(new regular_expression("need", false));
	n[109] = grammar.insert(new regular_expression(";", false));
	n[110] = grammar.insert(new stem(1, true));
	n[111] = grammar.insert(new stem(9, true));
	...
	n[121] = grammar.insert(new regular_expression("have", false));
	n[122] = grammar.insert(new regular_expression("\\0", false));
	n[123] = grammar.insert(new stem(1, true));
	n[124] = grammar.insert(new stem(7, true));
	n[125] = grammar.insert(new stem(6, true));
	n[126] = grammar.insert(new stem(5, true));
	n[127] = grammar.insert(new stem(4, true));
	n[128] = grammar.insert(new stem(3, true));
	n[129] = grammar.insert(new stem(2, true));
	...
	n[61]->next.push_back(n[59]);
	n[62]->next.push_back(n[59]);
	n[63]->next.push_back(n[62]);
	n[63]->next.push_back(n[61]);
	n[63]->next.push_back(n[60]);
	n[64]->next.push_back(n[63]);
	n[65]->next.push_back(n[68]);
	...
	n[117]->next.push_back(n[110]);
	n[118]->next.push_back(n[117]);
	n[119]->next.push_back(n[118]);
	n[120]->next.push_back(n[119]);
	n[121]->next.push_back(n[120]);
	n[122]->next.push_back(NULL);
	n[123]->next.push_back(n[122]);
	n[124]->next.push_back(n[130]);
	n[124]->next.push_back(n[123]);
	n[125]->next.push_back(n[130]);
	n[125]->next.push_back(n[123]);
	n[126]->next.push_back(n[130]);
	n[126]->next.push_back(n[123]);
	n[127]->next.push_back(n[130]);
	n[127]->next.push_back(n[123]);
	n[128]->next.push_back(n[130]);
	n[128]->next.push_back(n[123]);
	n[129]->next.push_back(n[130]);
	n[129]->next.push_back(n[123]);
	n[130]->next.push_back(n[129]);
	n[130]->next.push_back(n[128]);
	n[130]->next.push_back(n[127]);
	n[130]->next.push_back(n[126]);
	n[130]->next.push_back(n[125]);
	n[130]->next.push_back(n[124]);

	grammar.rules[0].start.push_back(n[130]);
	grammar.rules[1].start.push_back(n[0]);
	grammar.rules[2].start.push_back(n[121]);
	grammar.rules[3].start.push_back(n[108]);
	grammar.rules[4].start.push_back(n[103]);
	grammar.rules[5].start.push_back(n[94]);
	grammar.rules[5].start.push_back(n[93]);
	grammar.rules[6].start.push_back(n[88]);
	grammar.rules[7].start.push_back(n[83]);
	grammar.rules[8].start.push_back(n[57]);
	grammar.rules[9].start.push_back(n[1]);
	grammar.rules[10].start.push_back(n[70]);
	grammar.rules[11].start.push_back(n[2]);
	grammar.rules[12].start.push_back(n[64]);
	grammar.rules[13].start.push_back(n[51]);
	grammar.rules[14].start.push_back(n[41]);
	grammar.rules[15].start.push_back(n[35]);
	grammar.rules[16].start.push_back(n[28]);
	grammar.rules[16].start.push_back(n[26]);
	grammar.rules[17].start.push_back(n[25]);
	grammar.rules[17].start.push_back(n[23]);
	grammar.rules[18].start.push_back(n[22]);
	grammar.rules[18].start.push_back(n[17]);
	grammar.rules[18].start.push_back(n[16]);
	grammar.rules[18].start.push_back(n[15]);
	grammar.rules[19].start.push_back(n[3]);
	grammar.rules[20].start.push_back(n[14]);
}
